    ...
    <div className="min-h-screen bg-gray-50 pt-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600">Celkem objednávek: {orders.length}</p>
            </div>
            <Link 
              to="/admin"
            ...
            >
              <svg className="mr-2 -ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" role="img" aria-label="Šipka zpět">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 sm:flex sm:justify-between">
                        ...
                        <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                          <p>
                            Doručení: {format(new Date(order.deliveryDate), 'dd.MM.yyyy', { locale: cs })}
                          </p>
                        </div>
                      </div>
      ...
      {selectedOrder && (
        <div
          ...
          onKeyDown={(e) => { if (e.key === 'Escape' || e.key === 'Enter' || e.key === ' ') { setSelectedOrder(null); } }}
        >
          {/* Modal content */}
          <div
            ...
            <div className="mt-3">
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  ...
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" role="img" aria-label="Zavřít">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    {format(new Date(selectedOrder.deliveryDate), 'dd.MM.yyyy (EEEE)', { locale: cs })}
                  </p>
                </div>

                {selectedOrder.photos && selectedOrder.photos.length > 0 && (
                  <div>
                    <h4 className="font-medium text-gray-900">Fotografie ({selectedOrder.photos.length})</h4>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    {format(new Date(selectedOrder.createdAt), 'dd.MM.yyyy HH:mm', { locale: cs })}
                  </p>
                </div>
              </div>

								...
								<div className="bg-blue-50 border border-blue-200 rounded px-3 py-2">
									<div className="flex items-start gap-2">
										...
										<div className="flex-1 min-w-0">
											...
											{order.cakeMessage && (
												<p className="text-xs text-blue-700 mt-0.5 italic truncate">
													"{order.cakeMessage}"
												</p>
											)}
										</div>
				...
				<div>
					...
					>
						<div className="flex items-center gap-2">
							...
							<div className="flex-1">
								<p
									className={`text-sm font-medium ${isOverdue ? "text-red-900" : "text-gray-900"}`}
								>
						...
						<div className="flex gap-1 flex-wrap">
							{order.photos.slice(0, 5).map((photo, index) => (
								<a
									...
									className="group relative w-[100px] h-[100px] rounded overflow-hidden bg-gray-100 hover:ring-2 hover:ring-pink-500 transition-all flex-shrink-0"
								>
									<img
										src={`/photo/${photo.id}`}
